...
def checkVRAM():
    ...
    print(f"--- VRAM Monitor")
    print(f" -- Used VRAM: {vramUsed:.2f} / {vramTotal:.2f} GB")
    print("----")
...
def clearVRAM():
    ...
    print(f"--- Emptying VRAM")
    print(f" -- Memory Cleared: {vramAvailable - vramFinal:.2f} GB")
    print(f" -- Current Occupied Memory: {vramFinal:.2f} GB")
    print(f" -- Free Memory: {vramTotal - vramFinal:.2f} / {vramTotal:.2f} GB")
    print("----")
