...
Above shows the model getting undergoing a 3 epoch training. It can be observed that the eval_loss consistently drops in 3 epochs, demonstrating the capability of a tiny model to learn patterns when given a specialized task.
