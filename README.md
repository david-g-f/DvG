...
V3 - ~600 samples combination of Deepset and BIPIA. Model is now under-relaxed, confident in code statements but unable to determine that injections are unsafe.
